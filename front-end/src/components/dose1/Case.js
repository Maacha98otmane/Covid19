...
export default function RadioButtonsGroup(props) {
  ...
  return (
    ...
    {/* <Button variant="outlined" onClick={handleClickOpen}>Submit</Button> */}
      ...
      {(value.yes ||value.no) && <MultiStep covid={value.yes} noCovid={value.no} chronic_disease={chronic_disease} value={value} handleClose={handleClose} open={open} /> }
      </>
  );
}